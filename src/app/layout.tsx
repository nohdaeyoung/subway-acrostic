...
export const metadata: Metadata = {
  ...
  title: {
    default: "지하철역 시짓기 놀이 — 서울·부산 지하철역 삼행시 모음",
    template: "%s | 지하철역 시짓기 놀이",
  },
  description:
  ...
  authors: [{ name: "지하철역 시짓기 놀이", url: BASE_URL }],
  creator: "지하철역 시짓기 놀이",
  publisher: "지하철역 시짓기 놀이",
  alternates: { canonical: "/" },
  openGraph: {
    type: "website",
    locale: "ko_KR",
    url: BASE_URL,
    siteName: "지하철역 시짓기 놀이",
    title: "지하철역 시짓기 놀이 — 서울·부산 지하철역 삼행시 모음",
    description: "서울·부산 700개 이상 지하철역 이름으로 쓴 N행시를 노선도 위에서 감상하세요.",
    images: [{ url: `${BASE_URL}/og`, width: 1200, height: 630, alt: "지하철역 시짓기 놀이" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "지하철역 시짓기 놀이 — 서울·부산 지하철역 삼행시",
    description: "서울·부산 700개 이상 지하철역 이름으로 쓴 N행시를 노선도 위에서 감상하세요.",
