...
export const SEOUL_STATIONS: StationData[] = [
  ...
  { id: "s-daegok", name: "대곡", lat: 37.6347, lng: 126.7983, lines: ["3", "gyeongui", "seohaeseon", "gtxa"] },
  ...
  { id: "s-byeolnae", name: "별내", lat: 37.6478, lng: 127.1285, lines: ["gyeongchun"] },
  ...
  { id: "s-goksan", name: "곡산", lat: 37.5898, lng: 126.7870, lines: ["seohaeseon"] },
  { id: "s-wonjong", name: "원종", lat: 37.5180, lng: 126.7910, lines: ["seohaeseon"] },
  { id: "s-bucheon_stadium", name: "부천종합운동장", lat: 37.5043, lng: 126.7855, lines: ["7", "seohaeseon"] },
  { id: "s-sosa", name: "소사", lat: 37.4832, lng: 126.7988, lines: ["1", "seohaeseon"] },
  { id: "s-sosaeul", name: "소새울", lat: 37.4660, lng: 126.7940, lines: ["seohaeseon"] },
  { id: "s-siheungdaeya", name: "시흥대야", lat: 37.4480, lng: 126.7860, lines: ["seohaeseon"] },
  { id: "s-siheungsicheong", name: "시흥시청", lat: 37.4380, lng: 126.7740, lines: ["seohaeseon"] },
  { id: "s-siheungneunggok", name: "시흥능곡", lat: 37.4270, lng: 126.7560, lines: ["seohaeseon"] },
  { id: "s-dalmi", name: "달미", lat: 37.4100, lng: 126.7360, lines: ["seohaeseon"] },
  { id: "s-seonbu", name: "선부", lat: 37.3910, lng: 126.7311, lines: ["seohaeseon"] },
  { id: "s-choji", name: "초지", lat: 37.3770, lng: 126.7330, lines: ["4", "seohaeseon"] },
  { id: "s-wonsi", name: "원시", lat: 37.3640, lng: 126.7230, lines: ["seohaeseon"] },
  ...
  { id: "s-seongnam_gtx", name: "성남", lat: 37.4395, lng: 127.1376, lines: ["gtxa"] },
  { id: "s-guseong", name: "구성", lat: 37.3350, lng: 127.1090, lines: ["gtxa"] },
  { id: "s-dongtan", name: "동탄", lat: 37.2070, lng: 127.0710, lines: ["gtxa"] },

  // ===== 김포골드라인 =====
  // 김포공항 already defined
  { id: "s-gochon", name: "고촌", lat: 37.5901, lng: 126.7686, lines: ["gimpo_gold"] },
  { id: "s-pungmu", name: "풍무", lat: 37.6063, lng: 126.7449, lines: ["gimpo_gold"] },
  { id: "s-sau", name: "사우(김포시청)", lat: 37.6175, lng: 126.7150, lines: ["gimpo_gold"] },
  { id: "s-geolpo", name: "걸포북변", lat: 37.6108, lng: 126.7014, lines: ["gimpo_gold"] },
  { id: "s-unyang", name: "운양", lat: 37.6190, lng: 126.6970, lines: ["gimpo_gold"] },
  { id: "s-janggi", name: "장기", lat: 37.6276, lng: 126.6888, lines: ["gimpo_gold"] },
  { id: "s-masan_gp", name: "마산", lat: 37.6368, lng: 126.6818, lines: ["gimpo_gold"] },
  { id: "s-gurae", name: "구래", lat: 37.6480, lng: 126.6750, lines: ["gimpo_gold"] },
  { id: "s-yangchon", name: "양촌", lat: 37.6563, lng: 126.6564, lines: ["gimpo_gold"] },
  ...
  { id: "s-heungseong", name: "흥선", lat: 37.6850, lng: 127.0358, lines: ["uijeongbu"] },
  { id: "s-uijeongbu_center", name: "의정부중앙", lat: 37.6925, lng: 127.0365, lines: ["1", "uijeongbu"] },
  { id: "s-dongo", name: "동오", lat: 37.7005, lng: 127.0385, lines: ["uijeongbu"] },
  { id: "s-saemal", name: "새말", lat: 37.7100, lng: 127.0380, lines: ["uijeongbu"] },
  { id: "s-ggbuk", name: "경기도청북부청사", lat: 37.7195, lng: 127.0374, lines: ["uijeongbu"] },
  { id: "s-hyoja", name: "효자", lat: 37.7280, lng: 127.0355, lines: ["uijeongbu"] },
  { id: "s-gonje", name: "곤제", lat: 37.7370, lng: 127.0332, lines: ["uijeongbu"] },
  { id: "s-eoryong", name: "어룡", lat: 37.7465, lng: 127.0325, lines: ["uijeongbu"] },
  { id: "s-songsan_uj", name: "송산", lat: 37.7565, lng: 127.0340, lines: ["uijeongbu"] },
  { id: "s-tapseok", name: "탑석", lat: 37.7640, lng: 127.0380, lines: ["uijeongbu"] },
  ...
  { id: "s-bupyeong_gu", name: "부평구청", lat: 37.5098, lng: 126.7218, lines: ["incheon1"] },
  ...
  { id: "s-seonhak", name: "선학", lat: 37.4221, lng: 126.7058, lines: ["incheon1"] },
  { id: "s-sinyeonsu", name: "신연수", lat: 37.4130, lng: 126.7020, lines: ["incheon1"] },
  { id: "s-woninjae", name: "원인재", lat: 37.4037, lng: 126.6993, lines: ["incheon1"] },
  { id: "s-dongchun_ic", name: "동춘", lat: 37.3945, lng: 126.6870, lines: ["incheon1"] },
  { id: "s-dongmak", name: "동막", lat: 37.3870, lng: 126.6760, lines: ["incheon1"] },
  { id: "s-campustown", name: "캠퍼스타운", lat: 37.3801, lng: 126.6718, lines: ["incheon1"] },
  { id: "s-technopark", name: "테크노파크", lat: 37.3720, lng: 126.6715, lines: ["incheon1"] },
  { id: "s-jisik", name: "지식정보단지", lat: 37.3640, lng: 126.6690, lines: ["incheon1"] },
  { id: "s-incheondae", name: "인천대입구", lat: 37.3837, lng: 126.6582, lines: ["incheon1"] },
  { id: "s-centralpark", name: "센트럴파크", lat: 37.3785, lng: 126.6613, lines: ["incheon1"] },
  { id: "s-ibd", name: "국제업무지구", lat: 37.3815, lng: 126.6570, lines: ["incheon1"] },
  ...
  { id: "s-seongnam_ic", name: "석남", lat: 37.5100, lng: 126.6800, lines: ["incheon2"] },
  ...
  { id: "s-juan", name: "주안", lat: 37.4671, lng: 126.7076, lines: ["1", "incheon2"] },
